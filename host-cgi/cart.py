...
if(username==" "):
	...
	for x in loaded_json["carts"]:
		print "<div>"
		if x["purchased"] ==0:
			print "<h2>Current Cart</h2><div>Date Added " 
			print x["date"] + "  "
			for y in x["cart"]:
				print y["itemId"]
				productId=  y["itemId"]
				...
				print "Description:", product[2] , "</br>"
				print "Price:", product[3] , "</br>"
				print "<img src='../itemImages/"+ product[6] + "'></br>"
			print "</div>"
		print "</div><br>"
	...
	for x in loaded_json["carts"]:
		print "<div>"
		if x["purchased"] ==1:
			print '<div class="full-header">'+x["date"]+'</div>'
			print "<h2>Past Cart</h2><div>Date Added " 
			print x["date"] + "  "
			for y in x["cart"]:
				print y["itemId"]
				productId=  y["itemId"]
